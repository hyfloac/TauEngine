...
protected:
    virtual void* getProperty(void* object, const char* propName) const noexcept = 0;
    virtual const void* getProperty(const void* object, const char* propName) const noexcept = 0;
    virtual void setProperty(void* object, const char* propName, const void* value) const noexcept = 0;
};
