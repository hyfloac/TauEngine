...
public:
...
#ifdef _WIN32
    [[nodiscard]] virtual ID3D10Resource* dx10Resource() const noexcept { return nullptr; }
    [[nodiscard]] virtual ID3D10Buffer* dx10Buffer() const noexcept { return nullptr; }
    ...
    [[nodiscard]] virtual ID3D11Resource* dx11Resource() const noexcept { return nullptr; }
    [[nodiscard]] virtual ID3D11Buffer* dx11Buffer() const noexcept { return nullptr; }
    ...
    [[nodiscard]] virtual ID3D12Resource* dx12Resource() const noexcept { return nullptr; }
#endif
};
