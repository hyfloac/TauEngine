...
#pragma endregion
    ...
    inline const float* operator[](u32 index) const noexcept { return _data.glColumnMajorArr[index]; }
    inline       float* operator[](u32 index)       noexcept { return _data.glColumnMajorArr[index]; }
