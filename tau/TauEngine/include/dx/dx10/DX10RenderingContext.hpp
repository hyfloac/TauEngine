...
public:
    ...
    [[nodiscard]] Ref<IBufferBuilder> createBuffer(uSys descriptorCount) noexcept override { return null; }
...
protected:
    bool createContextsShared(Window& window, IRenderingContext** sharers, uSys count) noexcept override { return true; }
