...
static void fillUniformBinding(RefDynArray<u32>& arr, const ArrayList<BindPointUnion, 16>& map, GLuint program) noexcept;
static void fillUniformBlockBinding(RefDynArray<u32>& arr, const ArrayList<BindPointUnion, 16>& map, GLuint program) noexcept;
...
static void fillUniformBinding(RefDynArray<u32>& arr, const ArrayList<BindPointUnion, 16>& map, const GLuint program) noexcept
{
    if(map.count() == 0)
    {
        return;
...
static void fillUniformBlockBinding(RefDynArray<u32>& arr, const ArrayList<BindPointUnion, 16>& map, const GLuint program) noexcept
{
    if(map.count() == 0)
    {
        return;
