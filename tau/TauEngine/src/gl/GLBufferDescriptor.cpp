...
void GLBufferDescriptor::addAttribute(const Ref<IVertexBuffer> buffer, const u32 size, const DataType type, const bool normalized, const i32 stride, const void* const pointer) noexcept
{
