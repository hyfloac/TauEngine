...
//     : _data()
// {
//     this->_data.m00 = filler;
//     this->_data.m01 = filler;
//     this->_data.m02 = filler;
//     this->_data.m03 = filler;
//                       
//     this->_data.m11 = filler;
//     this->_data.m10 = filler;
//     this->_data.m12 = filler;
//     this->_data.m13 = filler;
//                       
//     this->_data.m22 = filler;
//     this->_data.m20 = filler;
//     this->_data.m21 = filler;
//     this->_data.m23 = filler;
//                       
//     this->_data.m33 = filler;
//     this->_data.m30 = filler;
//     this->_data.m31 = filler;
//     this->_data.m32 = filler;
// }
//
...
// }
//
// Matrix4x4f& Matrix4x4f::addComp(const Matrix4x4f& other) noexcept
// {
//     this->_data.m00 += other._data.m00;
//     this->_data.m01 += other._data.m01;
//     this->_data.m02 += other._data.m02;
//     this->_data.m03 += other._data.m03;
//
//     this->_data.m11 += other._data.m11;
//     this->_data.m10 += other._data.m10;
//     this->_data.m12 += other._data.m12;
//     this->_data.m13 += other._data.m13;
//
//     this->_data.m22 += other._data.m22;
//     this->_data.m20 += other._data.m20;
//     this->_data.m21 += other._data.m21;
//     this->_data.m23 += other._data.m23;
//
//     this->_data.m33 += other._data.m33;
//     this->_data.m30 += other._data.m30;
//     this->_data.m31 += other._data.m31;
//     this->_data.m32 += other._data.m32;
//
//     return *this;
// }
//
// Matrix4x4f& Matrix4x4f::subComp(const Matrix4x4f& other) noexcept
// {
//     this->_data.m00 -= other._data.m00;
//     this->_data.m01 -= other._data.m01;
//     this->_data.m02 -= other._data.m02;
...
// }
//
// Matrix4x4f& Matrix4x4f::mulComp(const Matrix4x4f& other) noexcept
// {
//     this->_data.m00 *= other._data.m00;
//     this->_data.m01 *= other._data.m01;
//     this->_data.m02 *= other._data.m02;
...
// }
//
// Matrix4x4f& Matrix4x4f::divComp(const Matrix4x4f& other) noexcept
// {
//     this->_data.m00 /= other._data.m00;
//     this->_data.m01 /= other._data.m01;
//     this->_data.m02 /= other._data.m02;
...
// }
//
// Matrix4x4f Matrix4x4f::mul(const Matrix4x4f& other) const noexcept
// {
// #define MAT_MUL(__X, __Y) ret.m ## __X ## __Y = oldData.m ## __X ## 0 * other._data.m0 ## __Y + \
//                                                 oldData.m ## __X ## 1 * other._data.m1 ## __Y + \
//                                                 oldData.m ## __X ## 2 * other._data.m2 ## __Y + \
//                                                 oldData.m ## __X ## 3 * other._data.m3 ## __Y;
//
...
// }
//
// Matrix4x4f Matrix4x4f::mulSIMD(const Matrix4x4f& other) const noexcept
// {
//     const Matrix4x4fData oldData = this->_data;
...
// {
//     this->_data.m00 += scalar;
//     this->_data.m01 += scalar;
//     this->_data.m02 += scalar;
//     this->_data.m03 += scalar;
//
//     this->_data.m11 += scalar;
//     this->_data.m10 += scalar;
//     this->_data.m12 += scalar;
//     this->_data.m13 += scalar;
//
//     this->_data.m22 += scalar;
//     this->_data.m20 += scalar;
//     this->_data.m21 += scalar;
//     this->_data.m23 += scalar;
//
//     this->_data.m33 += scalar;
//     this->_data.m30 += scalar;
//     this->_data.m31 += scalar;
//     this->_data.m32 += scalar;
//
//     return *this;
// }
//
...
// {
//     const __m128 vecFill = _mm_set1_ps(scalar);
//
...
// }
//
// // CompVec4& Matrix4x4f::preMul(Vector3f& vec) const noexcept
// // {
// //     const float x = vec.x();
// //     const float y = vec.y();
// //     const float z = vec.z();
// //
// //     vec.x() = x * this->_data.m00 + y * this->_data.m01 + z * this->_data.m02 + this->_data.m03;
// //     vec.y() = x * this->_data.m10 + y * this->_data.m11 + z * this->_data.m12 + this->_data.m13;
// //     vec.z() = x * this->_data.m20 + y * this->_data.m21 + z * this->_data.m22 + this->_data.m23;
// //     vec.data().w = 1.0f;
// //
// //     return vec;
// // }
// //
// // CompVec4& Matrix4x4f::preMul(Vector4f& vec) const noexcept
// // {
// //     const float x = vec.x();
// //     const float y = vec.y();
// //     const float z = vec.z();
// //     const float w = vec.w();
// //
// //     vec.x() = x * this->_data.m00 + y * this->_data.m01 + z * this->_data.m02 + w * this->_data.m03;
// //     vec.y() = x * this->_data.m10 + y * this->_data.m11 + z * this->_data.m12 + w * this->_data.m13;
// //     vec.z() = x * this->_data.m20 + y * this->_data.m21 + z * this->_data.m22 + w * this->_data.m23;
// //     vec.w() = x * this->_data.m30 + y * this->_data.m31 + z * this->_data.m32 + w * this->_data.m33;
// //
// //     return vec;
// // }
//
...
//     CompVec4 ret;
//
//     ret.x = x * this->_data.m00 + y * this->_data.m01 + z * this->_data.m02 + this->_data.m03;
//     ret.y = x * this->_data.m10 + y * this->_data.m11 + z * this->_data.m12 + this->_data.m13;
//     ret.z = x * this->_data.m20 + y * this->_data.m21 + z * this->_data.m22 + this->_data.m23;
//     ret.w = 1.0f;
//
//     return ret;
// }
...
//     CompVec4 ret;
//
//     ret.x = x * this->_data.m00 + y * this->_data.m01 + z * this->_data.m02 + w * this->_data.m03;
//     ret.y = x * this->_data.m10 + y * this->_data.m11 + z * this->_data.m12 + w * this->_data.m13;
//     ret.z = x * this->_data.m20 + y * this->_data.m21 + z * this->_data.m22 + w * this->_data.m23;
//     ret.w = x * this->_data.m30 + y * this->_data.m31 + z * this->_data.m32 + w * this->_data.m33;
//
//     return ret;
// }
//
// // CompVec4& Matrix4x4f::postMul(Vector3f& vec) const noexcept
// // {
// //     const float x = vec.x();
// //     const float y = vec.y();
// //     const float z = vec.z();
...
// // }
// //
// // CompVec4& Matrix4x4f::postMul(Vector4f& vec) const noexcept
// // {
// //     const float x = vec.x();
// //     const float y = vec.y();
// //     const float z = vec.z();
...
//     CompVec4 ret;
//
//     ret.x = x * this->_data.m00 + y * this->_data.m10 + z * this->_data.m20 + this->_data.m30;
//     ret.y = x * this->_data.m01 + y * this->_data.m11 + z * this->_data.m21 + this->_data.m31;
//     ret.z = x * this->_data.m02 + y * this->_data.m12 + z * this->_data.m22 + this->_data.m32;
//     ret.w = 1.0f;
//
//     return ret;
// }
...
//     CompVec4 ret;
//
//     ret.x = x * this->_data.m00 + y * this->_data.m10 + z * this->_data.m20 + w * this->_data.m30;
//     ret.y = x * this->_data.m01 + y * this->_data.m11 + z * this->_data.m21 + w * this->_data.m31;
//     ret.z = x * this->_data.m02 + y * this->_data.m12 + z * this->_data.m22 + w * this->_data.m32;
//     ret.w = x * this->_data.m03 + y * this->_data.m13 + z * this->_data.m23 + w * this->_data.m33;
//
//     return ret;
// }
//
...
// {
//     const SinCos<float> sinCos = fastSinCosR(angle);
//     const float nSin = -sinCos.sin;
//
//     const float nm10 = _data.m01 * sinCos.cos + _data.m02 * sinCos.sin;
//     const float nm11 = _data.m11 * sinCos.cos + _data.m12 * sinCos.sin;
//     const float nm12 = _data.m21 * sinCos.cos + _data.m22 * sinCos.sin;
//     const float nm13 = _data.m31 * sinCos.cos + _data.m32 * sinCos.sin;
//
//     _data.glColumnMajorArr[2][0] = _data.glColumnMajorArr[1][0] * nSin + _data.glColumnMajorArr[2][0] * sinCos.cos;
//     _data.glColumnMajorArr[2][1] = _data.glColumnMajorArr[1][1] * nSin + _data.glColumnMajorArr[2][1] * sinCos.cos;
//     _data.glColumnMajorArr[2][2] = _data.glColumnMajorArr[1][2] * nSin + _data.glColumnMajorArr[2][2] * sinCos.cos;
//     _data.glColumnMajorArr[2][3] = _data.glColumnMajorArr[1][3] * nSin + _data.glColumnMajorArr[2][3] * sinCos.cos;
//
...
// }
//
// Matrix4x4f Matrix4x4f::rotationXR(const float angleR) noexcept
// {
//     
// }
//
