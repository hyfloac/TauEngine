...
D3D11_CULL_MODE DX11RasterizerStateBuilder::dxCullMode(RasterizerArgs::CullMode cullMode) noexcept
{
    switch(cullMode)
    {
...
D3D11_FILL_MODE DX11RasterizerStateBuilder::dxFillMode(RasterizerArgs::FillMode fillMode) noexcept
{
    switch(fillMode)
    {
...
DX11RasterizerState* DX11RasterizerStateBuilder::build(const RasterizerArgs& args, Error* error) const noexcept
{
...
DX11RasterizerState* DX11RasterizerStateBuilder::build(const RasterizerArgs& args, Error* error, TauAllocator& allocator) const noexcept
{
    DXRasterizerArgs dxArgs;
    if(!processArgs(args, &dxArgs, error))
    { return null; }
...
CPPRef<IRasterizerState> DX11RasterizerStateBuilder::buildCPPRef(const RasterizerArgs& args, Error* error) const noexcept
{
    DXRasterizerArgs dxArgs;
    if(!processArgs(args, &dxArgs, error))
    { return null; }
...
NullableRef<IRasterizerState> DX11RasterizerStateBuilder::buildTauRef(const RasterizerArgs& args, Error* error, TauAllocator& allocator) const noexcept
{
    DXRasterizerArgs dxArgs;
    if(!processArgs(args, &dxArgs, error))
    { return null; }
...
NullableStrongRef<IRasterizerState> DX11RasterizerStateBuilder::buildTauSRef(const RasterizerArgs& args, Error* error, TauAllocator& allocator) const noexcept
{
    DXRasterizerArgs dxArgs;
    if(!processArgs(args, &dxArgs, error))
    { return null; }
...
bool DX11RasterizerStateBuilder::processArgs(const RasterizerArgs& args, DXRasterizerArgs* dxArgs, Error* error) const noexcept
{
