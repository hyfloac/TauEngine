...
#ifdef _WIN32
NullableRef<DXGI13GraphicsDisplay> DXGI13GraphicsDisplay::build(IDXGIOutput3* const dxgiOutput) noexcept
{
    ...
    return NullableRef<DXGI13GraphicsDisplay>(DefaultTauAllocator::Instance(), dxgiOutput, displayModes);
}
#endif
